...
import com.edanurhamurcu.newsfeedapp.util.Constants
import com.edanurhamurcu.newsfeedapp.util.Constants.Companion.SEARCH_DELAY
...
class SearchNewsFragment : Fragment (R.layout.fragment_search_news) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        var job: Job? = null
        edtTxtSearch.addTextChangedListener { editable->
        ...
        viewModel.searchNews.observe(viewLifecycleOwner, Observer { response->
            when(response){
                is com.edanurhamurcu.newsfeedapp.util.Resource.Success->{
                    hideProgressBar()
                    //check null
                ...
                is com.edanurhamurcu.newsfeedapp.util.Resource.Error->{
                    hideProgressBar()
                ...
                is com.edanurhamurcu.newsfeedapp.util.Resource.Loading->{
                    showProgressBar()
                }
            }
        })
    ...
    val scrollListener= object : RecyclerView.OnScrollListener(){
        ...
        override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
            ...
            if (shouldPaginate){
                viewModel.searchNews(edtTxtSearch.toString())
                isScrolling= false
            }else{
